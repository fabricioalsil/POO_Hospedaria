...
public class TelaVerificarConta extends JFrame implements Serializable {
    ...
    private void verifica() {
        if (hospedagem.saldoDevedor() == 0) {
            ...
            JOptionPane.showMessageDialog(this, "Erro: A conta nao foi fechada", "Erro ao fazer Checkout",
    ...
    private void actionAdicionar() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Erro: " + e.getMessage(), "Erro ao adionar pagamento",
                    JOptionPane.ERROR_MESSAGE);
        }
